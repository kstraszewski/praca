...
namespace ToupTek
{
    ...
    public class ToupCam : IDisposable
    {
        ...
        */
        ...
        [DllImport("toupcam.dll", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
        ...
        */
        ...
        /* get the version of this dll, which is: 33.13725.2019.0106 */
